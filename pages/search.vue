<template>
  <div>
    ...
    <div>There are {{ persons.length }} persons selected.</div>
    <div><Button label="Reset filters" @click="onReset" />.</div>
...
//   try {
//     const { data } = await useFetch("http://127.0.0.1:8008/persons/histbirths");

//     histbirths.value = data.value.result;
//   } catch (err) {
