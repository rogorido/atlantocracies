<template>
  <div>
    ...
    <DataTable :value="persons" ref="dt" paginator stripedRows :rows="10" :rowsPerPageOptions="[5, 10, 20, 50]"
      selectionMode="single" dataKey="_id" :selection="selectedPerson" @rowSelect="onRowSelect"
      v-model:filters="filters" filterDisplay="row" tableStyle="min-width: 25rem">
      <template #header>
      ...
      <Column field="birthyear" header="Birth Year" dataType="numeric" style="min-width: 3rem" sortable />
      <Column field="placebirth" header="Birth Place" dataType="string" style="min-width: 6rem" sortable />
      <Column field="datedeath" header="Death date" dataType="string" style="min-width: 6rem" sortable />
      <Column field="placeDeath" header="Death Place" dataType="string" style="min-width: 6rem" sortable />
      <Column field="gender" header="Gender" dataType="boolean" style="min-width: 3rem">
        <template #body="{ data }">
          <i class="pi" :class="{
      ...
      <Column field="wasMarried" header="Married" dataType="boolean" style="min-width: 3rem">
        <template #body="{ data }">
          <i class="pi" :class="{
      ...
      <Column field="hasFather" header="Has Father" dataType="boolean" style="min-width: 6rem">
        <template #body="{ data }">
          <i class="pi" :class="{
      ...
      <Column field="hizoTestamento" header="Made will" dataType="boolean" style="min-width: 3rem">
        <template #body="{ data }">
          <i class="pi" :class="{
      ...
      <Column field="numberOfEvents" header="# Events" dataType="numeric" style="min-width: 3rem" sortable />
      <Column field="numberofRelations" header="# Relations" dataType="numeric" style="min-width: 3rem" sortable />
      <Column field="numberofPositions" header="# Positions" dataType="numeric" style="min-width: 3rem" sortable />
      <Column field="numberofTitles" header="# Titles" dataType="numeric" style="min-width: 3rem" sortable />
    </DataTable>
  </div>
</template>
